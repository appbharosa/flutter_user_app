...
Future<void> init() async {
 ...
 sl.registerLazySingleton<HospitalFilterRepository>(() => HospitalFilterRepositoryImpl(remoteDataSource: sl(), networkInfo: sl()));
  ...
  sl.registerFactory(() => MedLockerBloc(
    getMedLockersUseCase: sl(),
    getMedLockerDetailUseCase: sl(),
    addMedLockerUseCase: sl(),
  ));
  ...
  sl.registerFactory(() => OnlineDoctorBloc(getDoctorsUseCase: sl()));
  ...
  sl.registerFactory(() => HospitalDiagnosticBookingBloc(
    bookHospitalDiagnosticUseCase: sl(),
  ));
